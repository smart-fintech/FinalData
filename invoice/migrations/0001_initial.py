    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Vouchetype', models.CharField(blank=True, choices=[('CREDIT NOTE VOUCHER', 'CREDIT NOTE VOUCHER'), ('DEBIT NOTE VOUCHER', 'DEBIT NOTE VOUCHER'), ('JOURNAL VOUCHER', 'JOURNAL VOUCHER'), ('SALES VOUCHER', 'SALES VOUCHER'), ('PAYMENT VOUCHER', 'PAYMENT VOUCHER'), ('RECEIPT VOUCHER', 'RECEIPT VOUCHER'), ('PURCHASE VOUCHER', 'PURCHASE VOUCHER'), ('CONTRA VOUCHER', 'CONTRA VOUCHER')], max_length=100, null=True)),
