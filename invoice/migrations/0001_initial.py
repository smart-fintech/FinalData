# Generated by Django 3.1.4 on 2021-10-12 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_details', models.CharField(blank=True, max_length=500, null=True)),
                ('company_details', models.CharField(blank=True, max_length=700, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Vouchetype', models.CharField(blank=True, choices=[('CREDIT NOTE VOUCHER', 'CREDIT NOTE VOUCHER'), ('CONTRA VOUCHER', 'CONTRA VOUCHER'), ('SALES VOUCHER', 'SALES VOUCHER'), ('RECEIPT VOUCHER', 'RECEIPT VOUCHER'), ('JOURNAL VOUCHER', 'JOURNAL VOUCHER'), ('PAYMENT VOUCHER', 'PAYMENT VOUCHER'), ('PURCHASE VOUCHER', 'PURCHASE VOUCHER'), ('DEBIT NOTE VOUCHER', 'DEBIT NOTE VOUCHER')], max_length=100, null=True)),
